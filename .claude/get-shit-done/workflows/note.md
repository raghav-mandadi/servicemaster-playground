...
- **Global scope**: `/Users/raghavmandadi/Desktop/leonwork/servicemaster/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/raghavmandadi/Desktop/leonwork/servicemaster/.claude/notes/`)
...
2. Glob `/Users/raghavmandadi/Desktop/leonwork/servicemaster/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/raghavmandadi/Desktop/leonwork/servicemaster/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/raghavmandadi/Desktop/leonwork/servicemaster/.claude/notes/` — works in any directory
